        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          >
            ...
            <input
              ...
              className="bg-elevated ring-line focus:ring-accent text-text placeholder:text-muted min-w-0 flex-1 rounded-xl px-4 py-3.5 text-[15px] ring-1 outline-none"
            />
            <button
              type="submit"
              className="bg-accent text-ink shrink-0 rounded-xl px-5 py-3.5 text-[15px] font-bold transition-transform hover:scale-[1.02]"
            >
              Subscribe
            </button>
          </form>
